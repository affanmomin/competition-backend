...
exports.analyzeCompetitorData = analyzeCompetitorData;
exports.analyzeWebpageData = analyzeWebpageData;
exports.generateText = generateText;
exports.analyzeTwitterCompetitorData = analyzeTwitterCompetitorData;
exports.analyzeLinkedInCompetitorData = analyzeLinkedInCompetitorData;
exports.analyzeGoogleMapsCompetitorData = analyzeGoogleMapsCompetitorData;
exports.analyzePlayStoreCompetitorData = analyzePlayStoreCompetitorData;
 ...
 */
function analyzeCompetitorData(request) {
...
Process the following competitor posts and comments:`;
        ...
        try {
            const response = yield axios_1.default.post(GEMINI_API_URL, body, {
                headers: {
            ...
            if (!response.data) {
                const errorText = yield response.data.text();
 ...
 */
function analyzeWebpageData(request) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!GEMINI_API_KEY) {
            console.log(GEMINI_API_KEY);
            throw new Error("GEMINI_API_KEY environment variable is required");
...
`;
        ...
        try {
            ...
            if (error instanceof SyntaxError) {
                throw new Error(`Failed to parse Gemini response for website analysis: ${error.message}`);
            }
            throw error;
        }
    });
 ...
 */
function analyzeTwitterCompetitorData(request) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!GEMINI_API_KEY) {
            console.log(GEMINI_API_KEY);
            throw new Error("GEMINI_API_KEY environment variable is required");
 ...
 */
function analyzeLinkedInCompetitorData(request) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!GEMINI_API_KEY) {
            console.log(GEMINI_API_KEY);
            throw new Error("GEMINI_API_KEY environment variable is required");
...
function analyzeGoogleMapsCompetitorData(request) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!GEMINI_API_KEY) {
            console.log(GEMINI_API_KEY);
            throw new Error("GEMINI_API_KEY environment variable is required");
...
function analyzePlayStoreCompetitorData(request) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!GEMINI_API_KEY) {
            console.log(GEMINI_API_KEY);
            throw new Error("GEMINI_API_KEY environment variable is required");
